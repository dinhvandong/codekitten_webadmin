...
export default class AddSoundList extends React.Component {
  ...
  onSaveProject(e)
  {
    ...
    //const file = input.files[0];
     ...
     formData.append("filetype","sound");
     formData.append("fileextend", 'wav');
  ...
  render() {
    ...
    if (imagePreviewUrl) {
      ...
      $imagePreview = (
        <div className="previewText">Chọn tệp âm thanh từ máy</div>
      );
    }
    return (
      <div>
            ...
            //     padding: '0px', overflow:'hidden'}}
              ...
              {$imagePreview}
                ...
                <div className={AddMoreCss.container}>
                  ...
                  <button 
                 // type="submit"
                   onClick={this.onSaveProject}>Upload File</button>
                </div>
              </form>
            </div>
          </view>
